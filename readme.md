...
## Purpose:
This console application aims to simplify and significantly hasten the process of changing a specific property value across many property files.

## Definitions:
* Property File: In the context of this application, a property file is a test file containing key-value pairs that are used to configure a program (such as an AFT).
...
* Upon opening, you are prompted to specify a folder (ex: C:\folderContainingAFTs) to do a deep search for property files in.
...
* Then you will be prompted to enter the common name shared between the property files you want to modify (ex: aft.properties).
